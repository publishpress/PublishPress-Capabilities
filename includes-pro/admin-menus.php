...
<div class="wrap publishpress-caps-manage pressshack-admin-wrapper pp-capability-menus-wrapper">
    ...
    <form method="post" id="ppc-admin-menu-form" action="admin.php?page=capsman-pp-admin-menus">
            ...
            <table id="akmin">
                <tr>
                    <td class="content">
                        ...
                        <dl>
                            <dt><?php printf(__('Admin Menu Restrictions for %s', 'capsman-enhanced'), $role_caption); ?></dt>
                            ...
                            <dd>
                                <div class="publishpress-headline">
                                    ...
                                    <?php 
                                    _e('Selected menus will be removed and menu page access blocked for the selected role.', 'capsman-enhanced');
                                    ?>
                                    </span>
                                </div>
                                ...
                                <div class="publishpress-headline">
                                    <span class="cme-subtext">
                                    <?php 
                                    $edit_role_url = admin_url('admin.php?page=capsman');

                                    printf(
                                        __('Other related access may be controlled by %s%s Capabilities%s.', 'capsman-enhanced'),
                                        "<a class='pp-capability-edit-role' href='$edit_role_url&role=$default_role'>",
                                        "<span class='pp-capability-role-caption'>$role_caption</span>",
                                        '</a>'
                                        );
                                    ?>
                                    </span>
                                                            ...
                                                            <td class="menu-column ppc-menu-item <?php echo $disabled_class;?>">
                                                                ...
                                                                <label for="check-item-<?php echo $sn;?>">
                                                                    ...
                                                                    <strong><i class="dashicons dashicons-arrow-right"></i>
                                                                        <?php echo strip_tags($menu_title);?>
                                                                    </strong></span>
                                                                </label> 
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function ($) {
            ...
            <?php if((int)$ppc_admin_menu_reload === 1){ ?>
                window.location = '<?php echo admin_url('admin.php?page=capsman-pp-admin-menus&role=' . $default_role . ''); ?>';
            <?php } ?>

            // -------------------------------------------------------------
            //   Set form action attribute to include role
            // -------------------------------------------------------------
            $('#ppc-admin-menu-form').attr('action', '<?php echo admin_url('admin.php?page=capsman-pp-admin-menus&role=' . $default_role . ''); ?>');
            ...
            $(document).on('change', '.pp-capability-menus-wrapper .ppc-admin-menu-role', function () {
                ...
                //go to url
                window.location = '<?php echo admin_url('admin.php?page=capsman-pp-admin-menus&role='); ?>' + $(this).val() + '';
