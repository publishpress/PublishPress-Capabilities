 ...
 *
 * TODO Search & Replace pp_capabilities_ with your prefix
 * TODO Search & Replace Pp_capabilities_ with your prefix
 * TODO Search & Replace 'capsman-enhanced' with your 'capsman-enhanced'
...
if (!class_exists('PP_Capabilities_Modules_Reviews')) {
    /**
     * Class PP_Capabilities_Modules_Reviews
     *
    ...
    class PP_Capabilities_Modules_Reviews
    {
        ...
        public static function init()
        {
            ...
            add_action('wp_ajax_pp_capabilities_review_action', [__CLASS__, 'ajax_handler']);
        }
        ...
        public static function hooks()
        {
            if (is_admin() && current_user_can('edit_posts')) {
                self::installed_on();
                if(is_pp_capabilities_admin_page()){
        ...
        {
            $installed_on = get_option('pp_capabilities_reviews_installed_on', false);

            if (!$installed_on) {
                $installed_on = current_time('mysql');
                update_option('pp_capabilities_reviews_installed_on', $installed_on);
            }
        ...
        public static function ajax_handler()
        {
            ...
            if (!wp_verify_nonce($_REQUEST['nonce'], 'pp_capabilities_review_action')) {
                wp_send_json_error();
            }
            ...
            try {
                ...
                update_user_meta($user_id, '_pp_capabilities_reviews_dismissed_triggers', $dismissed_triggers);
                update_user_meta($user_id, '_pp_capabilities_reviews_last_dismissed', current_time('mysql'));
        ...
        public static function dismissed_triggers()
        {
            ...
            $dismissed_triggers = get_user_meta($user_id, '_pp_capabilities_reviews_dismissed_triggers', true);
        ...
        public static function already_did($set = false)
        {
            ...
            if ($set) {
                update_user_meta($user_id, '_pp_capabilities_reviews_already_did', true);

                return true;
            }

            return (bool)get_user_meta($user_id, '_pp_capabilities_reviews_already_did', true);
        }
        ...
        public static function triggers($group = null, $code = null)
        {
            ...
            if (!isset($triggers)) {
                ...
                $time_message = __("Hey, you've been using Capabilities for %s on your site. We hope the plugin has been useful. Please could you quickly leave a 5-star rating on WordPress.org? It really does help to keep Capabilities growing.",
                    'capsman-enhanced');

                $triggers = apply_filters('pp_capabilities_reviews_triggers', [
                    'time_installed' => [
                        'triggers' => [
                            'one_week'     => [
                            ...
                            'one_month'    => [
                                'message'    => sprintf($time_message, __('1 month', 'capsman-enhanced')),
                                'conditions' => [
                            ...
                            'three_months' => [
                                'message'    => sprintf($time_message, __('3 months', 'capsman-enhanced')),
                                'conditions' => [
        ...
        public static function admin_notices()
        {
            ...
            <div class="notice notice-success is-dismissible pp-capabilities-notice">

                <p>
                    <?php echo $tigger['message']; ?>
                </p>
                <p>
                    <a class="button button-primary pp-capabilities-dismiss" target="_blank"
                       href="https://wordpress.org/support/plugin/capability-manager-enhanced/reviews/?rate=5#rate-response"
                       data-reason="am_now">
                        <strong><?php _e('Click here to add your rating for Pp-capabilities', 'capsman-enhanced'); ?></strong>
                    </a> <a href="#" class="button pp-capabilities-dismiss" data-reason="maybe_later">
                        <?php _e('Maybe later', 'capsman-enhanced'); ?>
                    </a> <a href="#" class="button pp-capabilities-dismiss" data-reason="already_did">
                        <?php _e('I already did', 'capsman-enhanced'); ?>
                    </a>
                </p>
        ...
        public static function admin_footer()
        {
                ...
                (function($) {
                    ...
                    function dismiss(reason) {
                        $.ajax({
                            ...
                            url: ajaxurl,
                            data: {
                                action: 'pp_capabilities_review_action',
                                nonce: '<?php echo wp_create_nonce('pp_capabilities_review_action'); ?>',
                                group: trigger.group,
                                code: trigger.code,
                                pri: trigger.pri,
                                reason: reason
                    ...
                    $(document)
                        .on('click', '.pp-capabilities-notice .pp-capabilities-dismiss', function(event) {
                            var $this = $(this),
                                reason = $this.data('reason'),
                                notice = $this.parents('.pp-capabilities-notice')
                        ...
                        .ready(function() {
                            setTimeout(function() {
                                $('.pp-capabilities-notice button.notice-dismiss').click(function(event) {
                                    dismiss('maybe_later')
                                })
                            }, 1000)
                        })
            ...
            <style>
            .pp-capabilities-notice p {
				margin-bottom: 0;
			}

			.pp-capabilities-notice img.logo {
				float: right;
				margin-left: 10px;
				width: 75px;
				padding: 0.25em;
             ...
             .button-primary.pp-capabilities-dismiss {
        ...
        public static function last_dismissed()
        {
            ...
            return get_user_meta($user_id, '_pp_capabilities_reviews_last_dismissed', true);
        }
...
PP_Capabilities_Modules_Reviews::init();
