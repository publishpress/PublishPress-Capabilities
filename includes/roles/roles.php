<div class="wrap publishpress-caps-manage pressshack-admin-wrapper pp-capability-roles-wrapper">
    ...
    <div class="wrap">
        ...
        $table = pp_roles()->admin->get_roles_list_table();
        $table->prepare_items();
                    ...
                    <div class="form-wrap">
                        ...
                        <form id="addrole" method="post" action="" class="validate">
                            ...
                            <div class="form-field form-required">
                                <label for="role"><?php _e('Role', 'capsman-enhanced') ?> </label>
                                <input name="role" id="role" type="text" value="" size="40"
                                       aria-required="true">
                                <p><?php _e('A unique identifier for the new role.', 'capsman-enhanced'); ?></p>
                            </div>
                            <div class="form-field form-required">
