 ...
 */
class Publishpress_Capabilities_Download_Monitor
{
    ...
    public static function instance()
    {
        if (is_null(self::$instance)) {
            self::$instance = new Publishpress_Capabilities_Download_Monitor();
        }
...
Publishpress_Capabilities_Download_Monitor::instance();
?>
